...
?>
    ...
    <div id="main-container" class="container-fluir">
        <div class="col-md-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control"name="bio" id="bio" rows="5" placeholder="Conte quem você é, o que faz, onde trabalha..."><?= $userData->bio ?></textarea>    
                        </div>
                    </div>
                </div>
