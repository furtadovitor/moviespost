        ...
        <div class="col-md-12">
            ...
            <div class="form-group">
                ...
                <select name="category" id="category" class="form-control">
                    ...
                    <option value="Ficção científica" <?= $movie->category === "Ficação científica" ? "selected" : ""?>>Ficção científica</option>
            ...
            <input type="submit" class="btn card-btn" valu="Editar filme">   
                    </form>
                </div>
                <div class="col-md-3">
